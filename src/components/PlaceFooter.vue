<template>
  <v-footer app fixed padless style="background-color: transparent !important;">
    <div class="footer-container d-flex flex-column">
      ...
      <div class="button-main-container d-flex" style="box-shadow: 0px -2px 4px -1px rgba(0, 0, 0, 0.2), 0px -4px 5px 0px rgba(0, 0, 0, 0.14), 0px -1px 10px 0px rgba(0, 0, 0, 0.12);">

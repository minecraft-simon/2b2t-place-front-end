<template>
    <div id="placePage" class="fill-height">
        ...
        <div v-show="!(maintenanceMode || sessionExpired || noConnection || cloudflareBlock)" class="fill-height">
            ...
            <v-main class="fill-height">
                <div id="placeContainer" ref="clickReceiver">
                    ...
                    <div v-for="(value, name) in botPositions" :key="name" class="map-marker map-marker-transition"
                        ...
                        <v-img v-else src="@/assets/map-markers/outside.png"
                               class="interpolation-nn outside-marker"></v-img>
                    </div>
                    <!-- other peoples selection highlights -->
                    <div v-for="highlight in selectionHighlights" :key="highlight.identifier"
                    ...
                    <div class="selected-pixel-label">
                        <v-sheet rounded elevation="4" class=""
                                 :style="'opacity: ' + (highlightLastPlayerName === '' ? 0 : 1)">
            ...
            <HowToUseDialog
                    v-if="!(maintenanceMode || noConnection || sessionExpired || cloudflareBlock)"></HowToUseDialog>
...
export default {
    ...
    setup() {
        ...
        const pixelSound = useSound(pixelSoundFile, {volume: 0.4})
        const colorSound = useSound(colorSoundFile, {playbackRate: playbackRate})
